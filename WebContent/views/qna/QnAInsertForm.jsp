...
<form action = "<%= request.getContextPath() %>/qInsert.qo" method="post" enctype="multipart/form-data">
	<div id ="boardArea" style="background:white;">
	      <label id="board-title">게시물 작성</label>
            <input type="reset" class="board-button" onclick="location.href='/6Days/selectList.qo'" value="취소" >
            <input type="submit" class="board-button" onclick="location.href='selectList.qo'" value="작성">
          <div id="board-area">
            <table id="boardWrite"> 
              <tr>
              ...
              <tr>
                ...
                <input type="text" id="board-subject" name="qtitle"></td>
              </tr>
              ...
              <tr>
                ...
                <input type="hidden" name="qdate"></td>
              ...
              <tr id="boardcontent">
                ...
                <textarea id="ckeditor" name="qcontent" style="float:left;"></TEXTAREA></td>
              </tr>
            </table>
          </div>
        </div>
